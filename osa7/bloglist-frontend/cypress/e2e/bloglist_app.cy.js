  ...
  describe("When logged in", function () {
    ...
    describe("and several blogs exists", function () {
      ...
      it("they can be liked", function () {
        cy.contains("Test blog one cypress").contains("view").click();
        ...
        cy.contains("Test blog two cypress").contains("view").click();
      ...
      it("they are sorted descending by likes", function () {
        ...
        cy.contains("Test blog three cypress").contains("view").click();
